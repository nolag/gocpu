...
// SetValue32 sets the 32 bit value held by this register.  Returns true if it is actually set
func (register *UintRegister32) SetValue32(value uint32) (bool, error) {
...
// SetValue32F sets the 32 bit value held by this register.  Returns true if it is actually set
func (register *UintRegister32) SetValue32F(value float32) (bool, error) {
...
// SetValue32 sets the 32 bit value held by this register.  Returns true if it is actually set
func (register *FloatRegister32) SetValue32(value uint32) (bool, error) {
...
// SetValue32F sets the 32 bit value held by this register.  Returns true if it is actually set
func (register *FloatRegister32) SetValue32F(value float32) (bool, error) {
...
func (ZeroRegister32) SetValue32(uint32) (bool, error) {
	return false, nil
}
...
func (ZeroRegister32) SetValue32F(float32) (bool, error) {
	return false, nil
}
